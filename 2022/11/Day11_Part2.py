...
#This version is manual. At the time I am writing this comment, I really want to optimize that and make it automatic so it can work with any given data
...
supermodulo = 19 * 2 * 3 * 17 * 13 * 7 * 5 * 11
